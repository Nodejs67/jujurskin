            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-1">
                ...
                <input value={form.nama} onChange={e => update("nama", e.target.value)}
                  className="w-full px-3 py-2 rounded-lg border border-border bg-secondary/30 text-foreground text-sm placeholder:text-muted-foreground/40 focus:outline-none focus:ring-1 focus:ring-primary"
          ...
          {[
            ...
            <div key={q.field} className="rounded-xl border border-border bg-card p-5">
              ...
              <textarea value={form[q.field] as string} onChange={e => update(q.field, e.target.value)} rows={3}
                className="w-full px-3 py-2.5 rounded-lg border border-border bg-secondary/30 text-foreground text-sm placeholder:text-muted-foreground/40 focus:outline-none focus:ring-1 focus:ring-primary resize-none"
