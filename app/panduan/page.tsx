...
const BEGINNER_MISTAKES = [
  {
    ...
    color: "text-red-700 bg-red-400/10 border-red-400/20",
  },
  {
    ...
    color: "text-orange-700 bg-orange-400/10 border-orange-400/20",
  },
  {
    ...
    color: "text-yellow-700 bg-yellow-400/10 border-yellow-400/20",
  },
  {
        ...
        {open && (
          ...
          >
            <div className="flex items-start gap-3 p-4 pt-0 border-t border-border bg-green-400/5">
              ...
              <div>
                <p className="text-xs text-green-700 font-medium mb-1">FAKTA</p>
    ...
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-14">
        ...
        <section>
          ...
          >
            <p className="text-xs text-amber-700 font-medium mb-1">⚠️ Aturan Aktif di Malam Hari</p>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-green-400/20 bg-green-400/5 p-3">
                      <p className="text-xs text-green-700 font-semibold mb-2">✅ Dianjurkan</p>
