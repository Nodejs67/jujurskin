      ...
      {value ? (
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-border bg-card text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
          />
...
function SafetyBadge({ ing }: { ing: Ingredient }) {
  const c = ing.safety_rating === "sangat_aman" ? "text-green-700" : ing.safety_rating === "aman" ? "text-blue-700" : "text-amber-700";
...
function EvidenceBadge({ ing }: { ing: Ingredient }) {
  const c = ing.evidence_level === "kuat" ? "text-green-700" : ing.evidence_level === "sedang" ? "text-amber-700" : "text-muted-foreground";
...
function IrritationBadge({ ing }: { ing: Ingredient }) {
  ...
  const c = ing.irritation_risk === "rendah" ? "text-green-700" : ing.irritation_risk === "sedang" ? "text-amber-700" : "text-red-700";
    ...
    return (
      <div className="rounded-xl border border-red-500/30 bg-red-500/5 p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-sm font-semibold text-red-700">Konflik — Jangan Dipakai Bersamaan!</p>
        </div>
        {conflictEntry && (
    ...
    return (
      <div className="rounded-xl border border-green-500/30 bg-green-500/5 p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-sm font-semibold text-green-700">Kompatibel — Bagus Dipakai Bersama!</p>
        </div>
  ...
  const rows: CompareRow[] = [
    ...
    },
    {
      ...
      getA: (i) => i.pregnancy_safe
        ? <span className="text-xs text-rose-700 font-semibold">✓ Aman</span>
    ...
    },
    {
      ...
      getA: (i) => i.beginner_friendly
        ? <span className="text-xs text-amber-700 font-semibold">⭐ Ya</span>
