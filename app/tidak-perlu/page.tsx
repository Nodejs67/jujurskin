                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-2 mb-1.5">
                            <span className="text-sm font-semibold text-foreground">{itemLabel(s.itemId)}</span>
                            <Badge variant="outline" className="text-[10px] px-1.5 py-0 border-yellow-400/40 text-yellow-700">
                              Tergantung kondisi
                            </Badge>
                          </div>
                          <p className="text-xs text-muted-foreground leading-relaxed">{s.reason}</p>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground">
                            {itemLabel(id)}{" "}
                            <span className={`text-xs font-normal ${ownedIt ? "text-green-700" : "text-yellow-700"}`}>
