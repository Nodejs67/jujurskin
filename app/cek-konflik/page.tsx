                ...
                <>
                                ...
                                <Badge
                                  ...
                                  className={`text-[10px] px-1.5 py-0 ${
                                    c.severity === "high"
                                      ...
                                      : "border-yellow-400/40 text-yellow-700"
                                  }`}
                                >
                  ...
                  {safeIngredients.length > 0 && conflicts.length > 0 && (
                    <div className="rounded-xl border border-green-400/20 bg-green-400/5 p-4">
                      <p className="text-xs text-green-700 font-semibold mb-2">Aman dikombinasikan:</p>
                      <div className="flex flex-wrap gap-2">
                        {safeIngredients.map((ing) => (
                          <span key={ing.id} className="text-xs text-green-700/80">{ing.emoji} {ing.name}</span>
                        ))}
                      </div>
                    </div>
                  )}
